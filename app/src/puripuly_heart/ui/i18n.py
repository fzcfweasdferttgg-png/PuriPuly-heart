...
_LOCALE_DISPLAY_ORDER = (
    "en", "ko", "zh-CN", "ja",
    "ar", "bg", "ca", "cs", "da", "de", "el", "es", "et", "fi", "fr",
    "hi", "hu", "id", "it", "lt", "lv", "ms", "nl", "no", "pl", "pt",
    "ro", "ru", "sk", "sv", "th", "tr", "uk", "vi", "zh-TW",
)
...
def native_locale_label(locale_code: str) -> str:
    """Language name in its own locale (e.g. 'de' → 'Deutsch')."""
    return t_for_locale(locale_code, f"locale.{locale_code}", default=locale_code)
