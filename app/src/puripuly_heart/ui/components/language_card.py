...
class LanguageCard(ft.Container):
    ...
    def __init__(
        ...
        on_second_target_click: Callable[[], None] | None = None,
    ):
        ...
        # --- Second target row (styled like self/peer rows) ---
        self._second_target_label = ft.Text(
            "",
            size=_CAPTION_TEXT_SIZE,
            weight=ft.FontWeight.W_600,
            color=COLOR_SECONDARY,
        ...
        self._second_target_text = ft.Text(
            "",
            size=34,
            weight=ft.FontWeight.BOLD,
            color=COLOR_NEUTRAL_DARK,
        ...
        _second_target_pair = ft.Container(
            content=ft.Row(
                [self._second_target_btn, _second_target_arrow_spacer, _second_target_spacer],
                spacing=10,
        ...
        content_with_glow = create_glow_stack(
            ft.Container(
                content=ft.Column(
                    [self._self_row, self._second_target_row, self._peer_row],
                    spacing=4,
                    alignment=ft.MainAxisAlignment.CENTER,
                ),
                expand=True,
