...
def _fallback_candidate_paths() -> Iterator[Path]:
    """In-package bundled artifact, then dev-tree build outputs, then portable bin/."""
    ...
    # Portable package: bin/ relative to app root (5 levels up from this file)
    # app/src/puripuly_heart/vendor/transcribe_cpp/_library.py -> ../../../../..
    app_root = pkg_dir.parent.parent.parent.parent.parent
    yield app_root / "bin" / name
